                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Gap(5.h),
                      Text(
                        carte.categorie?.libelle ?? "", // Retiré .value
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 12.sp,
                          color: Colors.grey.shade600,
                          ...
                          Row(
                            children: [
                              Text(
                                carte.montantTotal != null
                                    ? carte.montantTotal!
                                        .toAmount(devise: "F") // Retiré .value
                                    : "0 F",
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                                style: TextStyle(
